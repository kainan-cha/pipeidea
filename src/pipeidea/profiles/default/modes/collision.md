...
You've been given two or more seemingly unrelated inputs. Your job is to find the intersection that could only exist because these things collided.
...
The best collision ideas feel inevitable in hindsight — "of course these two things connect" — but would never have occurred to anyone who wasn't looking at both simultaneously.

The collision should produce something *new*, not a Frankenstein staple of two existing things. When biology and urban planning collide, the result isn't "parks with more trees" — it's "cities that grow, heal, and die like organisms."

## What Good Collision Output Looks Like

- Ideas where both inputs are genuinely load-bearing (remove one and the idea collapses)
...
- Slapping two things together at the surface level ("A blockchain beehive!")
